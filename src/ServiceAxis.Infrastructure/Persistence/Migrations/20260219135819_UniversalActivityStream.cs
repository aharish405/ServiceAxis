...
{
    /// <inheritdoc />
    public partial class UniversalActivityStream : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Activities_SysTables_TableId",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FieldChanges_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalSchema: "platform",
                        principalTable: "Activities",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_RecordId_CreatedAt",
                schema: "platform",
                table: "Activities",
                columns: new[] { "RecordId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Activities_TableId",
                schema: "platform",
                table: "Activities",
                column: "TableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldChanges_ActivityId",
                schema: "platform",
                table: "FieldChanges",
                column: "ActivityId");
        }
